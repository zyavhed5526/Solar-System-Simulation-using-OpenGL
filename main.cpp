...
void setup(void){
	...
	Image* sta = loadBMP("Resources/stars.bmp");		staTexture = loadTexture(sta);		delete sta;
	Image* sun = loadBMP("Resources/sun.bmp");		sunTexture = loadTexture(sun);		delete sun;
	Image* mer = loadBMP("Resources/mercury.bmp");	merTexture = loadTexture(mer);		delete mer;
	Image* ven = loadBMP("Resources/venus.bmp");		venTexture = loadTexture(ven);		delete ven;
	Image* ear = loadBMP("Resources/earth.bmp");		earTexture = loadTexture(ear);		delete ear;
	Image* mar = loadBMP("Resources/mars.bmp");		marTexture = loadTexture(mar);		delete mar;
	Image* jup = loadBMP("Resources/jupiter.bmp");	jupTexture = loadTexture(jup);		delete jup;
	Image* sat = loadBMP("Resources/saturn.bmp");		satTexture = loadTexture(sat);		delete sat;
	Image* ura = loadBMP("Resources/uranus.bmp");		uraTexture = loadTexture(ura);		delete ura;
	Image* nep = loadBMP("Resources/neptune.bmp");	nepTexture = loadTexture(nep);		delete nep;
	Image* plu = loadBMP("Resources/pluto.bmp");		pluTexture = loadTexture(plu);		delete plu;
	Image* log = loadBMP("Resources/logo.bmp");		logTexture = loadTexture(log);		delete log;
